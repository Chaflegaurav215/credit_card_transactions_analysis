...
--This project analyzes credit card transaction data to uncover spending patterns across different Indian cities. 
--Each record in the dataset captures essential details such as transaction_id, city, transaction_date, card_type, 
--expense type (exp_type), gender, and transaction amount. The dataset represents real-world transaction history 
--where users make purchases using various card types like Debit, Credit, Platinum, and Business cards. 
--By querying and validating this data, the project aims to identify trends in user spending behavior across 
--cities such as Bangalore and Mumbai. SQL validations ensure data accuracy by checking for duplicate transactions, 
--missing values, and inconsistent card or expense types. The project also highlights how spending differs across genders,
--card categories, and transaction dates. Overall, this system provides a reliable foundation for generating insights, 
--dashboards, and automated reports for financial decision-making.
